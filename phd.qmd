...
The incredible complexity of biological systems presents significant obstacles to attempts to understanding of them. My thesis explores some approaches to tackling this complexity with a particular focus on the study of systems in developmental biology.
...
Moreover, it is increasingly common to consider the development systems as performing information processing [@Tkacik2021].
...
The transfer of information from the joint distribution of gene concentration across the two cells in the two marginal distributions of gene concentration in each individual cell is discussed in the context of *canalization* and the idea of *positional information*.
